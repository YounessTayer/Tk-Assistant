...
btn4.grid(sticky='WE')
btn5 = tk.Button(root, text='Button 5. 8 sec timer')
btn5.grid(sticky='WE')
btn6 = tk.Button(root, text='Button 6. All together now!')
btn6.grid(sticky='WE')

# To show how to use on other widgets, create a label.
txt_lab = tk.Label(root, bg='plum', text='This is text on a simple label')
txt_lab.grid()
